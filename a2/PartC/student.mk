...
HDRS = VirtualSerial.h Descriptors.h packetizer.h crypto.h base64url.h ../randombytes_salsa20XMC_random.h
...
LIBLNK =  -L ../sodium/sodium-1.0.15/lib -lsodium
...
SCFLAGS += -O1
SCFLAGS += -I ../sodium/sodium-1.0.15/include
SCFLAGS += -I ../sodium/sodium-1.0.15/include/sodium
